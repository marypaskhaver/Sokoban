...
struct Sound {
    ...
    // MARK: - Beach Themes
    static let beachThemeOneStorageA = ["beach_1st_thA.mp3"]

    static let beachThemeTwoStoragesA = ["beach_2st_thA_pt1.mp3", "beach_2st_thA_pt2.mp3"]
    ...
    static let beachThemeThreeStoragesD = ["beach_3st_thD_pt1.mp3", "beach_3st_thD_pt2.mp3", "beach_3st_thD_pt3.mp3"]
    ...
    static let darkThemeThreeStoragesC = ["dark_3st_thC_pt1.mp3", "dark_3st_thC_pt2.mp3", "dark_3st_thC_pt3.mp3"]
    static let darkThemeThreeStoragesD = ["dark_3st_thD_pt1.mp3", "dark_3st_thD_pt2.mp3", "dark_3st_thD_pt3.mp3"]
    static let darkThemeThreeStoragesE = ["dark_3st_thE_pt1.mp3", "dark_3st_thE_pt2.mp3", "dark_3st_thE_pt3.mp3"]
    static let darkThemeThreeStoragesF = ["dark_3st_thF_pt1.mp3", "dark_3st_thF_pt2.mp3", "dark_3st_thF_pt3.mp3"]

    // MARK: - Jungle Themes
    static let jungleThemeOneStorageA = ["jungle_1st_thA.mp3"]

    static let jungleThemeTwoStoragesA = ["jungle_2st_thA_pt1.mp3", "jungle_2st_thA_pt2.mp3"]
    
    static let jungleThemeThreeStoragesA = ["jungle_3st_thA_pt1.mp3", "jungle_3st_thA_pt2.mp3", "jungle_3st_thA_pt3.mp3"]
    static let jungleThemeThreeStoragesB = ["jungle_3st_thB_pt1.mp3", "jungle_3st_thB_pt2.mp3", "jungle_3st_thB_pt3.mp3"]
