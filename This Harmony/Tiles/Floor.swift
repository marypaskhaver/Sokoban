...
class Floor: Tile {
    ...
    init(withTexture texture: SKTexture = SKTexture(imageNamed: Constants.TileNames.floor.rawValue)) {
//    init(withTexture texture: SKTexture = SKTexture(imageNamed: Constants.levelThemes[GameScene.level]!.floorImage[0])) {
